...
set_clock_groups -asynchronous \
    ...
    -group [get_clocks -quiet -include_generated_clocks -of_objects [get_ports -quiet sys_clk_p]] \
    -group [get_clocks -quiet -include_generated_clocks -of_objects [get_ports -quiet pcie_ref_clk_p]] \
