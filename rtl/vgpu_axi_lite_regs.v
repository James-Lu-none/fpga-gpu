...
//   Registers:
//     0x00: Doorbell (Write 1 to trigger hardware FSM / interrupt)
...
//     0x14: XDMA Descriptor Base Address [31:0]
//     0x18: XDMA Descriptor Base Address [63:32]
//     0x1C: Opcode Register (0 = Passthrough, 1 = Vector Add, 2 = Vector Mul)
//////////////////////////////////////////////////////////////////////////////////
...
module vgpu_axi_lite_regs #(
    ...
    output reg  [63:0]                   reg_desc_dma_addr,
    output reg  [31:0]                   reg_opcode,
    ...
    localparam [5:0] ADDR_DESC_LOW      = 6'h14;
    localparam [5:0] ADDR_DESC_HIGH     = 6'h18;
    localparam [5:0] ADDR_OPCODE        = 6'h1C;
    ...
    always @(posedge s_axi_aclk) begin
        if (!s_axi_aresetn) begin
            ...
            reg_desc_dma_addr  <= 64'd0;
            reg_opcode         <= 32'd1; // Default: Vector Add
            ...
            if (s_axi_awvalid && s_axi_wvalid && axi_awready_reg && axi_wready_reg) begin
                case (s_axi_awaddr[5:0])
                    ...
                    ADDR_DESC_LOW:  reg_desc_dma_addr[31:0]  <= s_axi_wdata;
                    ADDR_DESC_HIGH: reg_desc_dma_addr[63:32] <= s_axi_wdata;
                    ADDR_OPCODE:    reg_opcode               <= s_axi_wdata;
                    default: ;
                endcase
            end
        ...
        if (!s_axi_aresetn) begin
            ...
            if (axi_arready_reg && s_axi_arvalid && ~axi_rvalid_reg) begin
                ...
                case (s_axi_araddr[5:0])
                    ...
                    ADDR_DESC_LOW:   axi_rdata_reg <= reg_desc_dma_addr[31:0];
                    ADDR_DESC_HIGH:  axi_rdata_reg <= reg_desc_dma_addr[63:32];
                    ADDR_OPCODE:     axi_rdata_reg <= reg_opcode;
